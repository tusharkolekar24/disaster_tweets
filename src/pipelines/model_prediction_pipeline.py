...
class ModelPredictionConfig:
      file_path_trainset = os.path.join(os.getcwd(),'model_artifacts','train_test_dataset','training_trainset.csv')
      file_path_testset  = os.path.join(os.getcwd(),'model_artifacts','train_test_dataset','training_testset.csv')
      file_path_model_artifacts = os.path.join(os.getcwd(),'model_performance','train_models')
      file_path_train_performance = os.path.join(os.getcwd(),'model_performance','evaluating_performance','train')
      file_path_test_performance  = os.path.join(os.getcwd(),'model_performance','evaluating_performance','test')
